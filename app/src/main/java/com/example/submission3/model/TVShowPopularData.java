...
public class TVShowPopularData implements Parcelable {
    ...
    public TVShowPopularData (JSONObject object) {
        try {
    ...
    private TVShowPopularData(Parcel in) {
    ...
    public static final Parcelable.Creator<TVShowPopularData> CREATOR = new Parcelable.Creator<TVShowPopularData>() {
        @Override
        public TVShowPopularData createFromParcel(Parcel in) {
            return new TVShowPopularData(in);
        }
